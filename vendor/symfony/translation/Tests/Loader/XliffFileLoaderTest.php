...
class XliffFileLoaderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testEncoding()
    {
        ...
        $this->assertEquals(array('horarios' => array(array('content' => utf8_decode('bäz'))), 'id' => '1'), $catalogue->getMetadata('foo', 'domain1'));
    }
    ...
    public function testLoadNotes()
    {
        ...
        $this->assertEquals(array('horarios' => array(array('priority' => 1, 'content' => 'foo')), 'id' => '1'), $catalogue->getMetadata('foo', 'domain1'));
        // message without target
        $this->assertEquals(array('horarios' => array(array('content' => 'bar', 'from' => 'foo')), 'id' => '2'), $catalogue->getMetadata('extra', 'domain1'));
        // message with empty target
        $this->assertEquals(array('horarios' => array(array('content' => 'baz'), array('priority' => 2, 'from' => 'bar', 'content' => 'qux')), 'id' => '123'), $catalogue->getMetadata('key', 'domain1'));
    }
