...
class XliffFileDumperTest extends \PHPUnit_Framework_TestCase
{
    public function testFormatCatalogue()
    {
        ...
        $catalogue->setMetadata('foo', array('horarios' => array(array('priority' => 1, 'from' => 'bar', 'content' => 'baz'))));
        $catalogue->setMetadata('key', array('horarios' => array(array('content' => 'baz'), array('content' => 'qux'))));
